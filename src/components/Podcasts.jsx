                  ...
                  <div className="border-blue-300 border-2 rounded-2xl relative overflow-hidden p-7  border-transparent hover:border-blue-500 hover:shadow-md hover:shadow-blue-300">
                      <div className=" relative block h-full ">
                          <a href="detail-page.html" className="block">
                              <img src={podcast.cover} className="block w-full h-52 rounded-2xl object-cover" alt="" />
                          </a>
                      </div>
                      ...
                      <div className=" block pt-3 pb-0 px-5 custom-block-info">
                          ...
                          <div className="flex mt-2">
                              <img src={podcast.avatar} className=" rounded-full w-12 h-12 object-cover mr-2" alt=""/>
                              <p>{podcast.creator}<strong className="block">{podcast.creatorStatus}</strong></p>
                          </div>

                          <p className=" text-xs opacity-80 my-3">{podcast.desc}</p>

                          <div className="flex justify-between mt-3">
                              <a href="#"className="flex align-middle justify-center uppercase ml-1 hover:text-blue-500">
                                    <Download />
                      ...
                      <div className="absolute top-0 right-0 m-12 flex flex-col ms-auto">
                          <a href="#" className="bg-black hover:bg-blue-300 text-white rounded-full flex items-center justify-center text-center w-10 h-10 my-2  pb-1 badge ms-auto">
                              <Heart />
                          </a>
